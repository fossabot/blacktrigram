...
import type { AnimationFrame, KoreanText, Position } from "@/types/common";
import type {
  EnvironmentalEffectType,
  HitEffectType,
  ParticleType,
} from "@/types/effects";
import type { EffectIntensity } from "@/types/enums";

// Define core system types locally to avoid circular imports
export type EntityId = string;
export type Velocity = { readonly x: number; readonly y: number };

// Local type definitions to break cycles
